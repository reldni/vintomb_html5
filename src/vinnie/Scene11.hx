    ...
    function onHorseClicked()
    {
        if( isEquipped( Money ) )
        {
            ...
            function()
            {
                ...
                message( "You buy the key from the horse.  You now have the key to Vinnie's Tomb!" );
                var passCode =
                    if( game.shadesOn )
                    {
        ...
        else
        {
            ...
            {
                message( "The horse wants something else for the key.");
            }

            if( isEquipped( Sword ) )
            {
                message( "You really must stop threatning creatures with your sword." );
            }
        }
    }
